		...
		try {
			...
			mess = {
				...
				only: {
					...
					userB: `Hai Gan ${pushname2} Kamu Belom Terdaftar Didatabase Silahkan Ketik \n${prefix}daftar`,
			...
			const ownerNumber = ["18313535216@s.whatsapp.net"] // Owner Mr King
				...
				default:
                  ...
                  reply(`Maaf Kak, Command *${prefix}${command}* Tidak Terdaftar Di Dalam Database *${prefix}menu*`)
					...
					if (isGroup && isSimi && budy != undefined) {
						...
						console.log(color('[𝐌𝐑𝐊𝐈𝐍𝐆𝐁𝐎𝐓]','aqua'), 'Command Tidak Terdaftar', color(sender.split('@')[0]))
					}
                           }
		} catch (e) {

/*
* 𝐓𝐚𝐦𝐛𝐚𝐡𝐢𝐧 𝐧𝐚𝐦𝐚 𝐚𝐮𝐭𝐡𝐨𝐫 𝐥𝐚𝐡
* 𝐀𝐮𝐭𝐡𝐨𝐫 𝐌𝐡𝐚𝐧𝐤𝐁𝐚𝐫𝐁𝐚𝐫, 𝐅𝐚𝐫𝐡𝐚𝐧,𝐌𝐫𝐊𝐢𝐧𝐠
* 𝐓𝐚𝐦𝐛𝐚𝐡𝐢𝐧 𝐲𝐚 𝐂𝐚𝐩𝐞 𝐆𝐚𝐧 𝐧𝐠𝐞𝐟𝐢𝐱² 𝐘𝐠 𝐆𝐚 𝐰𝐨𝐫𝐤
* 𝐉𝐚𝐧 𝐧𝐮𝐦𝐩𝐚𝐧𝐠 𝐧𝐚𝐦𝐚 𝐝𝐨𝐚𝐧𝐤
* 𝐒𝐮𝐛𝐬𝐜𝐫𝐢𝐛𝐞 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 𝐌𝐫𝐊𝐢𝐧𝐠
* 𝐋𝐮 𝐌𝐚𝐮 𝐍𝐠𝐚𝐩𝐚𝐢𝐧 
* 𝐓𝐞𝐫𝐜𝐮𝐝𝐮𝐤 𝐋𝐮 𝐌𝐚𝐮 𝐆𝐚𝐧𝐭𝐢 𝐎𝐰𝐧𝐞𝐫𝐧𝐲𝐚 𝐆𝐚𝐧 
* 𝐂𝐫𝐚𝐜𝐤𝐞𝐝 𝐁𝐲 @𝐌𝐫𝐊𝐢𝐧𝐠
...
const { help, bahasa, donasi, limitend, limitcount, bottt } = require('./MrKing/help')
...
prefix = "!"
name = "~ 𝐌𝐑 𝐊𝐈𝐍𝐆 𝐁𝐎𝐓"
rdaftar = "𝐓𝐄𝐑𝐈𝐌𝐀 𝐊𝐀𝐒𝐈𝐇 𝐓𝐄𝐋𝐀𝐇 𝐃𝐀𝐅𝐓𝐀𝐑 𝐃𝐈 𝐌𝐑 𝐊𝐈𝐍𝐆 𝐁𝐎𝐓😁"
rmenu = "𝐇𝐀𝐈 𝐆𝐀𝐍 👋 𝐉𝐀𝐍𝐆𝐀𝐍 𝐋𝐔𝐏𝐀 𝐒𝐔𝐁𝐒𝐂𝐑𝐈𝐁𝐄 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 𝐌𝐑 𝐊𝐈𝐍𝐆 𝐘𝐀𝐀:)"
botinfo = "𝐔𝐍𝐓𝐔𝐊 𝐈𝐍𝐕𝐈𝐓𝐄 𝐁𝐎𝐓 𝐒𝐈𝐋𝐀𝐇𝐊𝐀𝐍 𝐒𝐔𝐁𝐒𝐂𝐑𝐈𝐁𝐄 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 𝐌𝐑 𝐊𝐈𝐍𝐆 𝐃𝐔𝐋𝐔 𝐘𝐀𝐀:)"
limitt = 10
memberLimit = 2
ban = []
premium = ["18313535216@s.whatsapp.net"]
...
async function starts() {
	...
	fs.existsSync('./MrKing.json') && client.loadAuthInfo('./MrKing.json')
	...
	await client.connect({timeoutMs: 30*1000})
        fs.writeFileSync('./MrKing.json', JSON.stringify(client.base64EncodedAuthInfo(), null, '\t'))
	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `𝐇𝐚𝐥𝐨 @${num.split('@')[0]}\n𝐒𝐞𝐥𝐚𝐦𝐚𝐭 𝐛𝐞𝐫𝐠𝐚𝐛𝐮𝐧𝐠 𝐝𝐢 𝐠𝐫𝐨𝐮𝐩 *${mdata.subject}*`
				...
				teks = `𝐒𝐞𝐥𝐚𝐦𝐚𝐭 𝐓𝐢𝐧𝐠𝐠𝐚𝐥 @${num.split('@')[0]} 𝐉𝐚𝐧𝐠𝐚𝐧 𝐊𝐞𝐥𝐮𝐚𝐫 𝐋𝐚𝐦𝐚 - 𝐋𝐚𝐦𝐚 𝐍𝐚𝐧𝐭𝐢 𝐃𝐨𝐢𝐧𝐲𝐚 𝐃𝐢 𝐀𝐦𝐛𝐢𝐥 𝐎𝐫𝐚𝐧𝐠 :𝐃``
				let buff = await getBuffer(ppimg)
				client.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				...
				only: {
					...
					userB: `*𝐇𝐚𝐢 𝐆𝐚𝐧 ${pushname2} 𝐊𝐚𝐦𝐮 𝐁𝐞𝐥𝐮𝐦 𝐃𝐢𝐝𝐚𝐭𝐚𝐛𝐚𝐬𝐞 𝐌𝐫𝐊𝐢𝐧𝐠𝐁𝐨𝐭 \n𝐒𝐢𝐥𝐚𝐡𝐤𝐚𝐧 𝐃𝐚𝐟𝐭𝐚𝐫 𝐃𝐮𝐥𝐮 𝐘𝐚 𝐃𝐞𝐧𝐠𝐚𝐧 𝐂𝐚𝐫𝐚\n\n𝐊𝐞𝐭𝐢𝐤 ${prefix}𝐝𝐚𝐟𝐭𝐚𝐫 ${pushname2}/𝟏𝟕/𝐤𝐨𝐭𝐚*`,
			...
			const ownerNumber = ["18313535216@s.whatsapp.net"] // Owner Bot MrKing
			...
			const checkLimit = (sender) => {
				...
				try {
					const getmemex = groupMembers.length
					    ...
					    client.sendMessage(from, `𝐌𝐚𝐚𝐟 ${name} 𝐓𝐢𝐝𝐚𝐤 𝐁𝐢𝐬𝐚 𝐌𝐚𝐬𝐮𝐤 𝐆𝐫𝐨𝐮𝐩 𝐊𝐚𝐫𝐧𝐚 𝐌𝐞𝐦𝐛𝐞𝐫 𝐆𝐫𝐨𝐮𝐩 ${groupMetadata.subject} Tidak Memenuhi Limit Member\n\nMinimal Member ${memberLimit}`, text)
		...
		case 'daftar':
					...
					if (isUser) return reply('𝐤𝐚𝐦𝐮 𝐬𝐮𝐝𝐚𝐡 𝐭𝐞𝐫𝐝𝐚𝐟𝐭𝐚𝐫 𝐝𝐚𝐥𝐚𝐦 𝐝𝐚𝐭𝐚𝐛𝐚𝐬𝐞 𝐌𝐫𝐊𝐢𝐧𝐠𝐁𝐨𝐭')
					if (isBanned) return reply(mess.only.benned)
					user.push(sender)
					...
					captionnya = `╭─「 𝐏𝐄𝐍𝐃𝐀𝐅𝐓𝐀𝐑𝐀𝐍 𝐔𝐒𝐄𝐑 」\`\`\`\n│ 𝐏𝐞𝐧𝐝𝐚𝐟𝐭𝐚𝐫𝐚𝐧 𝐛𝐞𝐫𝐡𝐚𝐬𝐢𝐥 𝐝𝐞𝐧𝐠𝐚𝐧 𝐒𝐍: \n│ 𝐓𝐌𝟎𝟖𝐌𝐑𝟖𝐊𝐈𝐍𝐆𝐒𝐉𝐃𝐇𝟏𝟎𝐉\`\`\`\n│\n│\`\`\`𝐏𝐚𝐝𝐚 ${date} ${time}\`\`\`\n│\`\`\`[𝐍𝐚𝐦𝐚]: ${pushname2}\`\`\`\n│\`\`\`[𝐍𝐨𝐦𝐨𝐫]: wa.me/${sender.split("@")[0]}\`\`\`\n│\`\`\`𝐒𝐮𝐛𝐬𝐜𝐫𝐢𝐛𝐞 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 𝐌𝐫 𝐊𝐢𝐧𝐠\`\`\`\n│\`\`\`𝐔𝐧𝐭𝐮𝐤 𝐌𝐞𝐧𝐠𝐠𝐮𝐧𝐚𝐤𝐚𝐧 𝐁𝐨𝐭\`\`\`\n│\`\`\`𝐬𝐢𝐥𝐚𝐡𝐤𝐚𝐧\`\`\`\n│\`\`\`𝐤𝐢𝐫𝐢𝐦 ${prefix}help/ ${prefix}menu\`\`\`\n│\`\`\`\n│𝐓𝐨𝐭𝐚𝐥 𝐏𝐞𝐧𝐠𝐠𝐮𝐧𝐚: ${user.length} Orang\`\`\`\n╰─────────────────────────`
          ...
          contextInfo: { mentionedJid: [from] }
           ...
           client.sendMessage(from, options, text, { quoted: mek } )
                ...
                client.sendMessage(from, `\`\`\`✓𝐒𝐮𝐤𝐬𝐞𝐬 𝐌𝐞𝐧𝐠𝐠𝐚𝐧𝐭𝐢 𝐍𝐚𝐦𝐚 𝐆𝐫𝐨𝐮𝐩 𝐌𝐞𝐧𝐣𝐚𝐝𝐢\`\`\` *${body.slice(9)}*`, text, {quoted: mek})
                break
                case 'setdesc':
                if (isBanned) return reply(mess.only.benned)    
                if (!isUser) return reply(mess.only.userB)
                ...
                client.sendMessage(from, `\`\`\`✓𝐒𝐮𝐤𝐬𝐞𝐬 𝐌𝐞𝐧𝐠𝐠𝐚𝐧𝐭𝐢 𝐃𝐞𝐬𝐤𝐫𝐢𝐩𝐬𝐢 𝐆𝐫𝐨𝐮𝐩\`\`\` *${groupMetadata.subject}* Menjadi: *${body.slice(9)}*`, text, {quoted: mek})
                break
				case 'tts':
				if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
         ...
         case 'lirik':
                ...
                if (!isPublic) return reply(mess.only.publikG)
                     const pesan = body.slice(8)
                      if (pesan.length > 300) return client.sendMessage(from, '𝐌𝐚𝐚𝐟 𝐓𝐞𝐤𝐬 𝐓𝐞𝐫𝐥𝐚𝐥𝐮 𝐏𝐚𝐧𝐣𝐚𝐧𝐠, 𝐌𝐚𝐤𝐬𝐢𝐦𝐚𝐥 𝟑𝟎𝟎 𝐓𝐞𝐤𝐬', text, {quoted: mek})
                ...
                if (!isPublic) return reply(mess.only.publikG)
                     const cfrr = body.slice(8)
                      if (cfrr.length > 300) return client.sendMessage(from, '𝐌𝐚𝐚𝐟 𝐓𝐞𝐤𝐬 𝐓𝐞𝐫𝐥𝐚𝐥𝐮 𝐏𝐚𝐧𝐣𝐚𝐧𝐠, 𝐌𝐚𝐤𝐬𝐢𝐦𝐚𝐥 𝟑𝟎𝟎 𝐓𝐞𝐤𝐬', text, {quoted: mek})
                        var nomor = mek.participant
...
// akhir fitur anime
			...
			case 'hekerbucin':
				...
				client.sendMessage(from, buffer, video, {mimtype: 'video/mp4', quoted: mek})
				await limitAdd(sender)
					break 
				case 'tiktokstalk':
					try {
...
//akhir kreator
		    ...
		    case 'map':
			    ...
			    if (!isPublic) return reply(mess.only.publikG)
					...
					mentions(`╔═══✪ Tag By *${pushname2}* ✪══`+ teks +'╚═══〘 𝐌𝐑 𝐊𝐈𝐍𝐆 𝐁𝐎𝐓 〙═══', members_id, true)
					break
			    case 'mentionall':
			    if (isBanned) return reply(mess.only.benned)    
			    if (!isUser) return reply(mess.only.userB)
			    if (!isPublic) return reply(mess.only.publikG)
					...
					mentions(`╔══〘  *${body.slice(12)}*  〙✪══`+teks+'╚═〘 𝐌𝐑 𝐊𝐈𝐍𝐆 𝐁𝐎𝐓 〙', members_id, true)
					break
			    case 'kbbi':
			    if (isBanned) return reply(mess.only.benned)    
			    if (!isUser) return reply(mess.only.userB)
				...
				case 'clearall':
					...
					reply(`\`\`\`𝐒𝐮𝐤𝐬𝐞𝐬 𝐝𝐞𝐥𝐞𝐭𝐞 𝐚𝐥𝐥 𝐜𝐡𝐚𝐭 𝐌𝐑 𝐊𝐈𝐍𝐆\`\`\``)
					break
                                case 'bcgc':
					client.updatePresence(from, Presence.composing) 
					if (!isOwner) return reply(mess.only.ownerB)
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of groupMembers) {
							client.sendMessage(_.jid, bcgc, image, {caption: `「 𝐁𝐑𝐎𝐀𝐃𝐂𝐀𝐒𝐓 𝐆𝐑𝐎𝐔𝐏 」\n*Group* : ${groupName}\n\n${body.slice(6)}`})
						}
						reply('')
					} else {
						for (let _ of groupMembers) {
							sendMess(_.jid, `「 𝐁𝐑𝐎𝐀𝐃𝐂𝐀𝐒𝐓 𝐆𝐑𝐎𝐔𝐏 」\n*Group* : ${groupName}\n\n${body.slice(6)}`)
						}
						reply('𝐒𝐮𝐤𝐬𝐞𝐬𝐬 𝐛𝐫𝐨𝐚𝐝𝐜𝐚𝐬𝐭 𝐠𝐫𝐨𝐮𝐩')
					}
					break
				case 'bc':
					if (!isOwner) return reply('Kamu siapa?')
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							client.sendMessage(_.jid, bc, image, {caption: `[ 𝐈𝐳𝐢𝐧 𝐁𝐫𝐨𝐚𝐝𝐜𝐚𝐬𝐭 ]\n\n${body.slice(4)}`})
						}
						reply('𝐒𝐮𝐤𝐬𝐞𝐬𝐬 𝐛𝐫𝐨𝐚𝐝𝐜𝐚𝐬𝐭')
					} else {
						for (let _ of anu) {
							sendMess(_.jid, `[ 𝐌𝐑 𝐊𝐈𝐍𝐆 𝐁𝐑𝐎𝐀𝐃𝐂𝐀𝐒𝐓 ]\n\n${body.slice(4)}`)
						}
						reply('𝐒𝐮????𝐞𝐬?? 𝐛𝐫𝐨𝐚𝐝𝐜𝐚𝐬𝐭')
					}
					break
				case 'add':
				if (isBanned) return reply(mess.only.benned)    
			    ...
			    if (!isPublic) return reply(mess.only.publikG)
					...
					if (mentioned.length > 1) {
						teks = '𝐏𝐞𝐫𝐢𝐧𝐭𝐚𝐡 𝐝𝐢 𝐭𝐞𝐫𝐢𝐦𝐚, 𝐦𝐞𝐧𝐠𝐞𝐥𝐮𝐚𝐫𝐤𝐚𝐧 :\n'
				...
				case 'kicktime':
					...
					mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
					setTimeout( () => {
					client.sendMessage(from, '𝐘𝐨𝐤 𝐒𝐚𝐦𝐚" 𝐀𝐥-𝐟𝐚𝐭𝐢𝐡𝐚𝐡', text)
					}, 8000)
					setTimeout( () => {
					reply('𝐬𝐮𝐤𝐬𝐞𝐬 𝐦𝐢𝐧:𝐃')
					}, 7000)
					...
					setTimeout( () => {
					client.sendMessage(from, `𝐁𝐢𝐬𝐦𝐢𝐥𝐚𝐡 𝐊𝐢𝐜𝐤 @${mentioned[0].split('@')[0]}`, text) // ur cods
					}, 5000)
					setTimeout( () => {
					client.sendMessage(from, '𝐀𝐬𝐢𝐤𝐤𝐤 𝐃𝐚𝐩𝐞𝐭 𝐌𝐚𝐤𝐚𝐧𝐚𝐧 𝐧𝐢𝐡𝐡:𝐃', text)
					}, 2500)
					setTimeout( () => {
					reply('𝐏𝐞𝐫𝐢𝐧𝐭𝐚𝐡 𝐃𝐢𝐭𝐞𝐫𝐢𝐦𝐚 𝐦𝐢𝐧:𝐃')
					}, 0)
					break
				case 'promote':
				case 'pm':
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
					if (mentioned.length > 1) {
						teks = '𝐏𝐞𝐫𝐢𝐧𝐭𝐚𝐡 𝐝𝐢 𝐭𝐞𝐫𝐢𝐦𝐚, 𝐚𝐧𝐝𝐚 𝐦𝐞𝐧𝐣𝐚𝐝𝐢 𝐚𝐝𝐦𝐢𝐧 :\n'
						for (let _ of mentioned) {
							teks += `@${_.split('@')[0]}\n`
						}
						mentions(teks, mentioned, true)
			    ...
			    if (!isPublic) return reply(mess.only.publikG)
					...
					mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
					if (mentioned.length > 1) {
						teks = '𝐏𝐞𝐫𝐢𝐧𝐭𝐚𝐡 𝐝𝐢 𝐭𝐞𝐫𝐢𝐦𝐚, 𝐚𝐧𝐝𝐚 𝐭𝐢𝐝𝐚𝐤 𝐦𝐞𝐧𝐣𝐚𝐝𝐢 𝐚𝐝𝐦𝐢𝐧 :\n'
						for (let _ of mentioned) {
							teks += `@${_.split('@')[0]}\n`
						}
						mentions(teks, mentioned, true)
				...
				case 'bott':
					...
					if (!isGroup) return reply(mess.only.group)
					if (!isGroupAdmins) return reply(mess.only.admin)
					if (args.length < 1) return reply('𝐏𝐢𝐥𝐢𝐡 𝐞𝐧𝐚𝐛𝐥𝐞 𝐚𝐭𝐚𝐮 𝐝𝐢𝐬𝐚𝐛𝐥𝐞!')
					if (args[0] === 'aktif') {
						if (isPublic) return reply('𝐒𝐮𝐝𝐚𝐡 𝐀𝐤𝐭𝐢𝐟')
						publik.push(from)
						fs.writeFileSync('./database/json/public.json', JSON.stringify(publik))
						reply(`𝐒𝐮𝐤𝐬𝐞𝐬 𝐒𝐢𝐥𝐚𝐡𝐤𝐚𝐧 𝐊𝐞𝐭𝐢𝐤 ${prefix}menu 𝐔𝐧𝐭𝐮𝐤 𝐅𝐢𝐭𝐮𝐫 𝐁𝐨𝐭')
				...
				if (!isGroupAdmins) return reply(mess.only.admin)
					...
					if ((args[0]) === 'on') {
						if (isSimi) return reply('𝐌𝐨𝐝𝐞 𝐬𝐢𝐦𝐢 𝐬𝐮𝐝𝐚𝐡 𝐚𝐤𝐭𝐢𝐟')
						samih.push(from)
						fs.writeFileSync('./database/json/simi.json', JSON.stringify(samih))
						reply(`\`\`\`✓𝐒𝐮𝐤𝐬𝐞𝐬 𝐦𝐞𝐧𝐠𝐚𝐤𝐭𝐢𝐟𝐤𝐚𝐧 𝐦𝐨𝐝𝐞 𝐬𝐢𝐦𝐢 𝐝𝐢 𝐠𝐫𝐨𝐮𝐩\`\`\` *${groupMetadata.subject}*`)
					} else if ((args[0]) === 'off') {
						samih.splice(from, 1)
						fs.writeFileSync('./database/json/simi.json', JSON.stringify(samih))
						reply(`\`\`\`✓𝐒𝐮𝐤𝐬𝐞𝐬 𝐦𝐞𝐧𝐨𝐧𝐚𝐤𝐭𝐢𝐟𝐤𝐚𝐧 𝐦𝐨𝐝𝐞 𝐬𝐢𝐦𝐢 𝐝𝐢 𝐠𝐫𝐨𝐮𝐩\`\`\` *${groupMetadata.subject}*`)
					} else {
						reply('𝐎𝐧 𝐮𝐧𝐭𝐮𝐤 𝐦𝐞𝐧𝐠𝐚𝐤𝐭𝐢𝐟𝐤𝐚𝐧, 𝐎𝐟𝐟 𝐮𝐧𝐭𝐮𝐤 𝐦𝐞𝐧𝐨𝐧𝐚𝐤𝐭𝐢𝐟𝐤𝐚𝐧')
					}
					break
			    case 'nsfw':
			    if (isBanned) return reply(mess.only.benned)    
			    ...
			    if (!isPublic) return reply(mess.only.publikG)
					...
					if ((args[0]) === 'on') {
						...
						reply(`\`\`\`✓𝐒𝐮𝐤𝐬𝐞𝐬 𝐦𝐞𝐧𝐠𝐚𝐤𝐭𝐢𝐟𝐤𝐚𝐧 𝐦𝐨𝐝𝐞 𝐧𝐬𝐟𝐰 𝐝𝐢 𝐠𝐫𝐨𝐮𝐩\`\`\` *${groupMetadata.subject}*`)
					} else if ((args[0]) === 'off') {
						nsfw.splice(from, 1)
						fs.writeFileSync('./database/json/nsfw.json', JSON.stringify(nsfw))
						reply(`\`\`\`✓𝐒𝐮𝐤𝐞𝐬 𝐦𝐞𝐧𝐨𝐧𝐚𝐤𝐭𝐢𝐟𝐤𝐚𝐧 𝐦𝐨𝐝𝐞 𝐧𝐬𝐟𝐰 𝐝𝐢 𝐠𝐫𝐨𝐮𝐩\`\`\` *${groupMetadata.subject}*`)
					} else {
						reply('𝐎𝐧 𝐮𝐧𝐭𝐮𝐤 𝐦𝐞𝐧𝐠𝐚𝐤𝐭𝐢𝐟𝐤𝐚𝐧, 𝐎𝐟𝐟 𝐮𝐧𝐭𝐮𝐤 𝐦𝐞𝐧𝐨𝐧𝐚𝐤𝐭𝐢𝐟𝐤𝐚𝐧')
					}
					break
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					if (args.length < 1) return reply('Hmmmm')
					if ((args[0]) === 'on') {
						if (isAnime) return reply('𝐌𝐨𝐝𝐞 𝐚𝐧𝐢𝐦𝐞 𝐬𝐮𝐝𝐚𝐡 𝐚𝐤𝐭𝐢𝐟')
						anime.push(from)
						fs.writeFileSync('./database/json/anime.json', JSON.stringify(anime))
						reply(`\`\`\`✓𝐒𝐮𝐤𝐬𝐞𝐬 𝐦𝐞𝐧𝐠𝐚𝐤𝐭𝐢𝐟𝐤𝐚𝐧 𝐦𝐨𝐝𝐞 𝐚𝐧𝐢𝐦𝐞 𝐝𝐢 𝐠𝐫𝐨𝐮𝐩\`\`\` *${groupMetadata.subject}*`)
					} else if ((args[0]) === 'off') {
						anime.splice(from, 1)
						fs.writeFileSync('./database/json/anime.json', JSON.stringify(anime))
						reply(`\`\`\`✓𝐒𝐮𝐤𝐞𝐬 𝐦𝐞𝐧𝐨𝐧𝐚𝐤𝐭𝐢𝐟𝐤𝐚𝐧 𝐦𝐨𝐝𝐞 𝐚𝐧𝐢𝐦𝐞 𝐝𝐢 𝐠𝐫𝐨𝐮𝐩\`\`\` *${groupMetadata.subject}*`)
					} else {
						reply('𝐎𝐧 𝐮𝐧𝐭𝐮𝐤 𝐦𝐞𝐧𝐠𝐚𝐤𝐭𝐢𝐟𝐤𝐚𝐧, 𝐎𝐟𝐟 𝐮𝐧𝐭𝐮𝐤 𝐦𝐞𝐧𝐨𝐧𝐚𝐤𝐭𝐢𝐟𝐤𝐚𝐧')
					}
					break
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					if (args.length < 1) return reply('Hmmmm')
					if ((args[0]) === 'on') {
						if (isWelkom) return reply('𝐔𝐝𝐚𝐡 𝐚𝐤𝐭𝐢𝐟 𝐠𝐚𝐧')
						welkom.push(from)
						fs.writeFileSync('./database/json/welkom.json', JSON.stringify(welkom))
						reply(`\`\`\`✓𝐒𝐮𝐤𝐬𝐞𝐬 𝐦𝐞𝐧𝐠𝐚𝐤𝐭𝐢𝐟𝐤𝐚𝐧 𝐟𝐢𝐭𝐮𝐫 𝐰𝐞𝐥𝐜𝐨𝐦𝐞 𝐝𝐢 𝐠𝐫𝐨𝐮𝐩\`\`\` *${groupMetadata.subject}*`)
					} else if ((args[0]) === 'off') {
						welkom.splice(from, 1)
						fs.writeFileSync('./database/json/welkom.json', JSON.stringify(welkom))
						reply(`\`\`\`✓𝐒𝐮𝐤𝐬𝐞𝐬 𝐦𝐞𝐧𝐨𝐧𝐚𝐤𝐭𝐢𝐟𝐤𝐚𝐧 𝐟𝐢𝐭𝐮𝐫 𝐰𝐞𝐥𝐜𝐨𝐦𝐞 𝐝𝐢 𝐠𝐫𝐨𝐮𝐩\`\`\` *${groupMetadata.subject}*`)
					} else {
						reply('𝐎𝐧 𝐮𝐧𝐭𝐮𝐤 𝐦𝐞𝐧𝐠𝐚𝐤𝐭𝐢𝐟𝐤𝐚𝐧, 𝐎𝐟𝐟 𝐮𝐧𝐭𝐮𝐤 𝐦𝐞𝐧𝐨𝐧𝐚𝐤𝐭𝐢𝐟𝐤𝐚𝐧')
					}
					break 
				...
				if (!isUser) return reply(mess.only.userB)
				if (!isPublic) return reply(mess.only.publikG)
				 data = fs.readFileSync('./database/json/18.json');
                 jsonData = JSON.parse(data);
		...
		case 'happymod':
			...
			break
				default:
                  ...
                  reply(`𝐌𝐚𝐚𝐟 𝐆𝐚𝐧, 𝐂𝐨𝐦𝐦𝐚𝐧𝐝 *${prefix}${command}* 𝐓𝐢𝐝𝐚𝐤 𝐓𝐞𝐫𝐝𝐚𝐟𝐭𝐚𝐫 𝐃𝐢 𝐃𝐚𝐥𝐚𝐦 𝐃𝐚𝐭𝐚𝐛𝐚𝐬𝐞 *${prefix}menu*`)
                  }
					if (isGroup && isSimi && budy != undefined) {
						...
						console.log(color('[MRKINGBOT]','aqua'), 'Command Tidak Terdaftar', color(sender.split('@')[0]))
					}
                           }
		} catch (e) {
